...
class Blockchain(object):
    ...
    def __init__(self):
        ...
        self.nodes = set()
        # ここでsetを使用する理由は新しいノードの追加がべき等にするため
    ...
    def valid_chain(self, chain):
        ...
        :return: <bool> True であれば正しく、False であればそうでない
        '''
...
# ノードを作る
# Flaskについて詳しくはこちら　http://flask.pocoo.org/docs/0.12/quickstart/#a-minimal-application
app = Flask(__name__)
